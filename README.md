...
**Links:** JSFiddle with example data from an actual serial data stream for client's web app at [http://jsfiddle.net/lukeblechl/5D5eD/118/](http://jsfiddle.net/lukeblechl/5D5eD/118/).
